...
function onCreatePost()
	--the icons
	makeLuaSprite('composer-icon', 'forestz', -155, 195)
	...
	makeGraphic('JukeBox', 300, 300, 'ff1a00')
	...
	makeLuaText('JukeBoxSubText', 'Song By: ForestZ', 300, -355, 155)
	setTextFont('JukeBoxSubText', 'PermanentMarker.ttf')
	setTextColor('JukeBoxSubText', '2a0900')
	setTextBorder('JukeBoxSubText', 1, '2a0900')
